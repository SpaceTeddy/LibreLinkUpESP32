 ...
 * @{
 */
#define VERSION_LIBRELINKUP_LIB "1.3.1" ///< Library version identifier
...
public:
     ...
     * - 1: Use built-in certificate
     * - 2: Use file-based certificate (downloaded to LittleFS on demand)
     * - 3: No certificate set here; call setCACertBundle() separately
    ...
    /**
     * @brief Configure the internal WiFiClientSecure with an x509 certificate bundle
